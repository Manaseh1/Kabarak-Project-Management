    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 p-5">
        <div class="col">
            <div class="card">
                ...
                $sql="select * from team_project_progress where step=1 and group_id='$regno'";
        ...
        <div class="col">
            <div class="card">
                ...
                $regno=$_GET['regno'];
                $url="comments.php?regno=".$regno;
                $sql="select * from team_project_progress where step=3 and group_id='$regno'";
                $query=mysqli_query($conn,$sql);
                $row=mysqli_fetch_assoc($query); 
                $file_link=$row['file_path'];
                ?>
        ...
        <div class="col">
            <div class="card">
                ...
                $regno=$_GET['regno'];
                $url="comments.php?regno=".$regno;
                $sql="select * from team_project_progress where step=4 and group_id='$regno'";
                $query=mysqli_query($conn,$sql);
                $row=mysqli_fetch_assoc($query); 
                $file_link=$row['file_path'];
                ?>
        ...
        <div class="col">
            <div class="card">
                ...
                $regno=$_GET['regno'];
                $url="comments.php?regno=".$regno;
                $sql="select * from team_project_progress where step=5 and group_id='$regno'";
                $query=mysqli_query($conn,$sql);
                $row=mysqli_fetch_assoc($query); 
                $file_link=$row['file_path'];
                ?>
        ...
        <div class="col">
            <div class="card">
                ...
                $regno=$_GET['regno'];
                $url="comments.php?regno=".$regno;
                $sql="select * from team_project_progress where step=6 and group_id='$regno'";
                $query=mysqli_query($conn,$sql);
                $row=mysqli_fetch_assoc($query); 
                $file_link=$row['file_path'];
                ?>
